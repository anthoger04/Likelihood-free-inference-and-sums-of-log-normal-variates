...
Following the updated project guidelines, **the main approach we present for Questions 1 and 2 utilizes the newly suggested fully conjugate priors:** $\sigma^2 \sim IG(a, b)$ and $\mu | \sigma^2 \sim \mathcal{N}(0, \kappa\sigma^2)$.
